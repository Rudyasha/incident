...
Постраничная документация по Задачам 1 и 2: гипотезы, анализ артефактов, предварительное заключение, вопросы аналитику и баг-репорт. Боковая навигация, поиск на русском, светлая/тёмная темы и небольшая архитектурная схема и одна диаграмма последовательности.
